# Generated by Django 3.2.5 on 2021-07-16 22:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, default='media/default.png', null=True, upload_to='profile_pic/', verbose_name='Image')),
                ('user_type', models.CharField(choices=[(1, 'Manager'), (2, 'Teachers'), (3, 'Students')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, default='media/default.png', null=True, upload_to='student_profile/', verbose_name='Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parmanent_address', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('classRoom', models.BigIntegerField(blank=True, null=True)),
